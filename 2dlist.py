...
def sum_of_numbers(passed_in_2D_list, rcount, ccount):
...
def main():
    ...
    for loop_counter_rows in range(0, rows):
        ...
        for loop_counter_columns in range(0, columns):
            ...
            print("{} ".format(a_random_number), end="")
        a_2d_list.append(temp_column)
        print("")

    sum_number = sum_of_numbers(a_2d_list, rows, columns)
    print("average: {} ".format(sum_number))
